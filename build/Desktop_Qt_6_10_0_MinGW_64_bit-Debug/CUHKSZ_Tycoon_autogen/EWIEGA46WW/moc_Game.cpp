...
template <> constexpr inline auto Game::qt_create_metaobjectdata<qt_meta_tag_ZN4GameE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QString &, int, int)>(28, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 29 }, { QMetaType::Int, 30 }, { QMetaType::Int, 26 },
        }}),
        // Signal 'landOnSelfProperty'
        QtMocHelpers::SignalData<void(int, const QString &)>(31, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 9 }, { QMetaType::QString, 22 },
        }}),
        // Signal 'openChanceCard'
        QtMocHelpers::SignalData<void(int, const QString &)>(32, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 9 }, { QMetaType::QString, 33 },
        }}),
        ...
        QtMocHelpers::SignalData<void(int, int)>(35, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 9 }, { QMetaType::Int, 36 },
        }}),
        // Signal 'rentPaid'
        QtMocHelpers::SignalData<void(const QString &, int, const QString &)>(37, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 26 }, { QMetaType::Int, 38 }, { QMetaType::QString, 27 },
        }}),
        ...
        QtMocHelpers::SignalData<void(int, int)>(41, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 9 }, { QMetaType::Int, 42 },
        }}),
        ...
        QtMocHelpers::SignalData<void(int, int, int, int)>(44, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 26 }, { QMetaType::Int, 27 }, { QMetaType::Int, 45 }, { QMetaType::Int, 42 },
        }}),
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 12: _t->taxPaymentRequired((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3]))); break;
        case 13: _t->landOnSelfProperty((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 14: _t->openChanceCard((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 15: _t->openCommunityCard((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 16: _t->landOnFreeParking((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 17: _t->rentPaid((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3]))); break;
        case 18: _t->gameLogMessage((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 19: _t->forceRaiseMoney((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 20: _t->playerBankrupt((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 21: _t->tradeProposed((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[4]))); break;
        case 22: _t->warningSignal((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (Game::*)(const QString & , int , int , int )>(_a, &Game::rentPaymentRequired, 11))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(const QString & , int , int )>(_a, &Game::taxPaymentRequired, 12))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , const QString & )>(_a, &Game::landOnSelfProperty, 13))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , const QString & )>(_a, &Game::openChanceCard, 14))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , const QString & )>(_a, &Game::openCommunityCard, 15))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , int )>(_a, &Game::landOnFreeParking, 16))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(const QString & , int , const QString & )>(_a, &Game::rentPaid, 17))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(const QString & )>(_a, &Game::gameLogMessage, 18))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , int )>(_a, &Game::forceRaiseMoney, 19))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int )>(_a, &Game::playerBankrupt, 20))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int , int , int , int )>(_a, &Game::tradeProposed, 21))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(const QString & )>(_a, &Game::warningSignal, 22))
            return;
    }
}
...
{
    QMetaObject::activate<void>(this, &staticMetaObject, 21, nullptr, _t1, _t2, _t3, _t4);
}
