...
void Card::execute(Player& player, Game& game) {
    ...
    switch (type) {
        ...
        case CardType::PAY_MONEY: {
            if (game.playerCanPay(player, amount)) {
        ...
        case CardType::COLLECT_FROM_PLAYERS: {
            game.receiveFromPlayers(player, amount);
            break;
        }

        case CardType::PAY_TO_PLAYERS: {
            game.payToPlayers(player, amount);
            break;
        }
        ...
        case CardType::REPAIRS: {
            ...
            if (game.playerCanPay(player, totalCost)) {
